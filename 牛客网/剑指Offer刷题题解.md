...
<!-- TOC -->autoauto- [《剑指Offer》 ——题解](#剑指offer-题解)auto    - [题目1：二维数组中的查找](#题目1二维数组中的查找)auto        - [思路：类似二分查找思想](#思路类似二分查找思想)auto        - [解法](#解法)auto    - [题目2：替换空格](#题目2替换空格)auto        - [思路：while循环处理](#思路while循环处理)auto        - [解法](#解法-1)auto    - [题目3：从尾到头打印链表](#题目3从尾到头打印链表)auto        - [思路 1：递归](#思路-1递归)auto        - [解法](#解法-2)auto    - [题目4：重建二叉树](#题目4重建二叉树)auto        - [思路 1：递归](#思路-1递归-1)auto        - [解法](#解法-3)auto    - [题目5：用两个栈实现队列](#题目5用两个栈实现队列)auto        - [思路 1：栈先进后出，队列先进先出](#思路-1栈先进后出队列先进先出)auto        - [解法](#解法-4)auto    - [题目6：旋转数组的最小数字](#题目6旋转数组的最小数字)auto        - [思路 1：二分查找](#思路-1二分查找)auto        - [解法](#解法-5)auto    - [题目7：斐波那契数列](#题目7斐波那契数列)auto        - [理解：](#理解)auto        - [思路 1：递归](#思路-1递归-2)auto        - [解法：](#解法)auto        - [思路 2：动态规划](#思路-2动态规划)auto        - [解法：](#解法-1)auto    - [题目8：跳台阶](#题目8跳台阶)auto        - [思路 1：动态规划](#思路-1动态规划)auto        - [解法：](#解法-2)auto    - [题目9：变态跳台阶](#题目9变态跳台阶)auto        - [思路 1：动态规划](#思路-1动态规划-1)auto        - [解法：](#解法-3)auto        - [思路 2：数学](#思路-2数学)auto        - [解法：](#解法-4)auto    - [题目10：矩形覆盖](#题目10矩形覆盖)auto        - [理解：](#理解-1)auto        - [思路 1：递归](#思路-1递归-3)auto        - [解法：](#解法-5)auto        - [思路 2：动态规划](#思路-2动态规划-1)auto        - [解法：](#解法-6)auto    - [★ 题目11：二进制中1的个数](#★-题目11二进制中1的个数)auto        - [理解：](#理解-2)auto        - [思路 1：位运算](#思路-1位运算)auto        - [解法：](#解法-7)auto    - [★ 题目12：数值的整数次方](#★-题目12数值的整数次方)auto        - [理解：](#理解-3)auto        - [思路 1：分类讨论](#思路-1分类讨论)auto        - [官方解法：](#官方解法)auto        - [模仿解法：](#模仿解法)auto    - [题目13：调整数组顺序使奇数位于偶数前面](#题目13调整数组顺序使奇数位于偶数前面)auto        - [理解：](#理解-4)auto        - [思路 1：队列+遍历](#思路-1队列遍历)auto    - [题目14：链表中倒数第k个结点](#题目14链表中倒数第k个结点)auto        - [理解：](#理解-5)auto        - [思路 1：快慢指针](#思路-1快慢指针)auto        - [思路 2：先得到链表长度，再循环处理到倒数第k个](#思路-2先得到链表长度再循环处理到倒数第k个)auto    - [题目15：反转链表](#题目15反转链表)auto        - [理解：](#理解-6)auto        - [思路 1：加 pre、node 和 临时节点tmp](#思路-1加-prenode-和-临时节点tmp)auto    - [★ 题目16：合并两个排序的链表](#★-题目16合并两个排序的链表)auto        - [理解：](#理解-7)auto        - [思路 1：递归](#思路-1递归-4)auto        - [思路 2：非递归](#思路-2非递归)auto    - [题目17：树的子结构](#题目17树的子结构)auto        - [理解：](#理解-8)auto        - [思路 1：递归](#思路-1递归-5)auto    - [题目18：二叉树的镜像](#题目18二叉树的镜像)auto        - [理解：](#理解-9)auto        - [思路 1：递归](#思路-1递归-6)auto    - [题目19：顺时针打印矩阵](#题目19顺时针打印矩阵)auto        - [思路 1：定义变量，依次循环](#思路-1定义变量依次循环)auto    - [题目20：包含min函数的栈](#题目20包含min函数的栈)auto        - [注意：](#注意)auto        - [思路 1：利用数据栈、最小值栈两个栈解决，时间复杂度为O（1）](#思路-1利用数据栈最小值栈两个栈解决时间复杂度为o1)auto    - [题目21：栈的压入、弹出序列](#题目21栈的压入弹出序列)auto        - [思路 1：利用辅助栈解决](#思路-1利用辅助栈解决)auto    - [题目25：复杂链表的复制](#题目25复杂链表的复制)auto        - [思路 1：三步法：先复制，再处理随机节点，最后拆分](#思路-1三步法先复制再处理随机节点最后拆分)auto    - [题目27：字符串的排列](#题目27字符串的排列)auto        - [思路：](#思路)auto        - [知识点：](#知识点)auto        - [解法1： 回溯法](#解法1-回溯法)auto    - [题目28：数组中出现次数超过一半的数字](#题目28数组中出现次数超过一半的数字)auto        - [解法1：哈希表](#解法1哈希表)auto            - [思路：](#思路-1)auto        - [解法2：候选法](#解法2候选法)auto            - [思路：](#思路-2)auto    - [题目29：最小的K个数](#题目29最小的k个数)auto        - [解法1： Arrays.sort() 排序](#解法1-arrayssort-排序)auto            - [思路：](#思路-3)auto    - [题目30：连续子数组的最大和](#题目30连续子数组的最大和)auto        - [解法1： 动态规划](#解法1-动态规划)auto            - [思路：](#思路-4)auto    - [题目32：把数组排成最小的数](#题目32把数组排成最小的数)auto        - [解法1： 回溯法（耗时太长）](#解法1-回溯法耗时太长)auto            - [注意：](#注意-1)auto            - [思路：](#思路-5)auto        - [解法2： 冒泡排序](#解法2-冒泡排序)auto            - [注意：](#注意-2)auto            - [思路：](#思路-6)auto    - [题目33：丑数](#题目33丑数)auto        - [解法1： 多指针](#解法1-多指针)auto            - [思路：](#思路-7)auto    - [题目34：第一个只出现一次的字符](#题目34第一个只出现一次的字符)auto        - [解法1： 哈希表（耗时太长）](#解法1-哈希表耗时太长)auto            - [注意：](#注意-3)auto            - [思路：](#思路-8)auto        - [解法2： 双指针循环](#解法2-双指针循环)auto            - [思路：](#思路-9)auto    - [题目37：数字在排序数组中出现的次数](#题目37数字在排序数组中出现的次数)auto        - [思路：](#思路-10)auto        - [解法1： 二分查找](#解法1-二分查找)auto            - [注意：](#注意-4)auto            - [思路：](#思路-11)auto    - [题目40：数组中只出现一次的数字](#题目40数组中只出现一次的数字)auto        - [解法1： 哈希表](#解法1-哈希表)auto            - [注意：](#注意-5)auto            - [思路：](#思路-12)auto    - [题目41：和为S的连续正数序列](#题目41和为s的连续正数序列)auto        - [解法1： 双层循环](#解法1-双层循环)auto            - [注意：](#注意-6)auto            - [思路：](#思路-13)auto        - [解法2： 双指针](#解法2-双指针)auto            - [思路：](#思路-14)auto    - [题目42：和为S的两个数字](#题目42和为s的两个数字)auto            - [注意：](#注意-7)auto        - [解法1： 双指针加入乘积判断：11ms](#解法1-双指针加入乘积判断11ms)auto            - [思路：](#思路-15)auto        - [解法2： 双指针：不用判断，利用 “因为 a 和 b 和一定， a 和 b 相差越多，乘积越小”](#解法2-双指针不用判断利用-因为-a-和-b-和一定-a-和-b-相差越多乘积越小)auto            - [思路：](#思路-16)auto    - [题目43：左旋转字符串](#题目43左旋转字符串)auto            - [注意：](#注意-8)auto        - [解法1： 循环每一位调整位置。](#解法1-循环每一位调整位置)auto            - [思路：](#思路-17)auto    - [题目44：翻转单词顺序列](#题目44翻转单词顺序列)auto            - [注意：](#注意-9)auto        - [解法1： 双指针，由最右侧开始循环存放每个单词到 list。](#解法1-双指针由最右侧开始循环存放每个单词到-list)auto            - [思路：](#思路-18)auto    - [题目45：扑克牌顺子](#题目45扑克牌顺子)auto            - [注意：](#注意-10)auto        - [解法1： 双指针，由最右侧开始循环存放每个单词到 list。](#解法1-双指针由最右侧开始循环存放每个单词到-list-1)auto            - [思路：](#思路-19)auto    - [题目46：孩子们的游戏(圆圈中最后剩下的数)](#题目46孩子们的游戏圆圈中最后剩下的数)auto            - [注意：](#注意-11)auto        - [解法1： 双指针，由最右侧开始循环存放每个单词到 list。](#解法1-双指针由最右侧开始循环存放每个单词到-list-2)auto            - [思路：](#思路-20)auto    - [题目47：求1+2+3+...+n](#题目47求123n)auto        - [解法1：递归](#解法1递归)auto            - [思路：](#思路-21)auto    - [题目48：不用加减乘除做加法](#题目48不用加减乘除做加法)auto        - [解法1：!!! 位运算做加法 !!!](#解法1-位运算做加法-)auto            - [思路：](#思路-22)auto    - [题目49：把字符串转换成整数](#题目49把字符串转换成整数)auto        - [解法1：字符串/循环判断](#解法1字符串循环判断)auto            - [思路：](#思路-23)auto    - [题目50：数组中重复的数字](#题目50数组中重复的数字)auto        - [解法1：哈希表](#解法1哈希表-1)auto            - [思路：](#思路-24)auto    - [题目51：构建乘积数组](#题目51构建乘积数组)auto        - [解法1：二层循环](#解法1二层循环)auto            - [思路：](#思路-25)auto        - [解法2：左右循环](#解法2左右循环)auto            - [思路：](#思路-26)autoauto<!-- /TOC -->
